...
export const MapView: React.FC<MapViewProps> = ({ atms = [], onValidateATM, votedAtms = [] }) => {
    ...
    <div className="relative h-full w-full bg-gray-100 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gray-50 w-full h-full overflow-hidden">
        ...
        {filteredATMs.map((atm) => (
          ...
          >
            <div className={`w-10 h-10 rounded-full ${getPinColor(atm.status)} border-4 border-white shadow-lg flex items-center justify-center relative`}>
